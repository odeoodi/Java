...
// tehdään kaikille kuville article elementit, joihin tulee tiedot picArraystä:

picArray.forEach(picture => {
  const pictures = document.getElementById('pictures')
  const article = document.createElement('article')
  const p = document.createElement('p')
  p.textContent = picture.caption
  ...
  figcaption.textContent = picture.description
  figure.appendChild(img)
  figure.appendChild(figcaption)
  h2.appendChild(figure).appendChild(p)
